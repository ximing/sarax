...
***************************************************************************** */
                        ...
                        function spy(listener) {
                            ...
                            return once(function() {
                                globalState.spyListeners = globalState.spyListeners.filter(function(
                                    l
                                ) {
                                    return l !== listener;
                                });
                        ...
                        function dontReassignFields() {
                            fail$1(
                                process.env.NODE_ENV !== "production" &&
                                    "@action fields are not reassignable"
                            );
                        }
                        ...
                        function defineBoundAction(target, propertyName, fn) {
                            addHiddenProp(
                                target,
                                propertyName,
                                createAction(propertyName, fn.bind(target))
                            );
                        }
                        ...
                        var ComputedValue = /** @class */ (function() {
                            ...
                            ComputedValue.prototype.trackAndCompute = function() {
                                ...
                                var wasSuspended =
                                    /* see #1208 */ this.dependenciesState ===
                        ...
                        var ObservableObjectAdministration = /** @class */ (function() {
                            ...
                            ObservableObjectAdministration.prototype.write = function(
                                owner,
                                key,
                                newValue
                            ) {
                                ...
                                if (newValue !== UNCHANGED) {
                                    ...
                                    if (notifySpy)
                                        spyReportStart(
                                            __assign({}, change, { name: this.name, key: key })
                                        );
                        ...
                        function generateComputedPropConfig(propName) {
                            return (
                                ...
                                (computedPropertyConfigs[propName] = {
                                    ...
                                    enumerable: false,
                                    get: function() {
                                        return getAdministrationForComputedPropOwner(this).read(
                                            this,
                                            propName
                                        );
                                    },
                                    set: function(v) {
                                        getAdministrationForComputedPropOwner(this).write(
                                            this,
                                            propName,
                                            v
                                        );
                        ...
                        function isObservableProp(value, propName) {
                            if (typeof propName !== "string")
                                return fail$1(
                                    process.env.NODE_ENV !== "production" &&
                                        "expected a property name as second argument"
                                );
                        ...
                        var computedDecorator = createPropDecorator(false, function(
                            ...
                            defineComputedProperty(
                                instance,
                                propertyName,
                                __assign({}, options, { get: get, set: set })
                            );
                        });
                        ...
                        function createObservable(v, arg2, arg3) {
                            ...
                            var res = isPlainObject(v)
                                ...
                                : Array.isArray(v)
                                    ...
                                    : isES6Map(v) ? observable.map(v, arg2) : v;
                        ...
                        addHiddenFinalProp(
                            ...
                            typeof Symbol !== "undefined" ? Symbol.toStringTag : "@@toStringTag",
                            "Map"
                        );
                        ...
                        function getAtom(thing, property) {
                            if (typeof thing === "object" && thing !== null) {
                                ...
                                if (isObservableMap(thing)) {
                                    ...
                                    var observable =
                                        anyThing._data.get(property) ||
                                        anyThing._hasMap.get(property);
                                    if (!observable)
                                        fail$1(
                                            process.env.NODE_ENV !== "production" &&
                                                "the entry '" +
                        ...
                        function interceptHook(hook, thing, arg2, arg3) {
                            var atom =
                                typeof arg2 === "string" ? getAtom(thing, arg2) : getAtom(thing);
                        ...
                        var ObservableArrayAdministration = /** @class */ (function() {
                            ...
                            ObservableArrayAdministration.prototype.spliceWithArray = function(
                                ...
                                if (arguments.length === 1) deleteCount = length - index;
                                    ...
                                    deleteCount = Math.max(
                                        0,
                                        Math.min(deleteCount, length - index)
                                    );
         ...
         */
                        ...
                        function propagateChangeConfirmed(observable) {
                            ...
                            while (i--) {
                                ...
                                if (d.dependenciesState === exports.IDerivationState.POSSIBLY_STALE)
                                    ...
                                    d.dependenciesState === exports.IDerivationState.UP_TO_DATE // this happens during computing of `d`, just keep lowestObserverState up to date.
                                )
                                    observable.lowestObserverState =
                        ...
                        function checkIfStateModificationsAreAllowed(atom) {
                            ...
                            if (
                                ...
                                (hasObservers$$1 || globalState.enforceActions === "strict")
                            )
                                fail$1(
                                    process.env.NODE_ENV !== "production" &&
                        ...
                        function bindDependencies(derivation) {
                            ...
                            var lowestNewObservingDerivationState =
                                exports.IDerivationState.UP_TO_DATE;
                        ...
                        function trace() {
                            ...
                            if (derivation.isTracing === TraceMode.NONE) {
                                console.log(
                                    "[mobx.trace] '" + derivation.name + "' tracing enabled"
                                );
                            }
                            derivation.isTracing = enterBreakPoint
                                ? TraceMode.BREAK
                                : TraceMode.LOG;
                        }
                        ...
                        function whenPromise(predicate, opts) {
                            if (process.env.NODE_ENV !== "production" && opts && opts.onError)
                                return fail$1(
                                    "the options 'onError' and 'promise' cannot be combined"
                                );
                            var cancel;
                        ...
                        function configure(options) {
                            ...
                            if (enforceActions !== undefined) {
                                if (
                                    typeof enforceActions !== "boolean" &&
                                    enforceActions !== "strict"
                                )
                                    return fail(
                                        "Invalid configuration for 'enforceActions': " +
                                            enforceActions
                                    );
                                globalState.enforceActions = enforceActions;
                                globalState.allowStateChanges =
                                    enforceActions === true || enforceActions === "strict"
                                        ? false
                                        : true;
                            }
                            ...
                            if (arguments.length !== 1)
                                fail$1(
                                    process.env.NODE_ENV &&
                                        "Flow expects one 1 argument and cannot be used as decorator"
                                );
                        ...
                        function interceptReads(thing, propOrHandler, handler) {
                            ...
                            if (target.dehancer !== undefined)
                                return fail$1(
                                    process.env.NODE_ENV !== "production" &&
                                        "An intercept reader was already established"
                                );
                            target.dehancer =

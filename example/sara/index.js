...
"use strict";
/* WEBPACK VAR INJECTION */(function(process, global) {/* unused harmony export Reaction */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return observable; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return extendObservable; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__store__ = __webpack_require__("./src/store.js");
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Store", function() { return __WEBPACK_IMPORTED_MODULE_0__store__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__wmp_sara_connect__ = __webpack_require__("./src/wmp-sara/connect.js");
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "connect", function() { return __WEBPACK_IMPORTED_MODULE_1__wmp_sara_connect__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__wmp_sara_inject__ = __webpack_require__("./src/wmp-sara/inject.js");
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "inject", function() { return __WEBPACK_IMPORTED_MODULE_2__wmp_sara_inject__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__wmp_sara_helper__ = __webpack_require__("./src/wmp-sara/helper.js");
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "mapState", function() { return __WEBPACK_IMPORTED_MODULE_3__wmp_sara_helper__["e"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "mapMutations", function() { return __WEBPACK_IMPORTED_MODULE_3__wmp_sara_helper__["d"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "mapGetters", function() { return __WEBPACK_IMPORTED_MODULE_3__wmp_sara_helper__["c"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "mapActions", function() { return __WEBPACK_IMPORTED_MODULE_3__wmp_sara_helper__["b"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "createNamespacedHelpers", function() { return __WEBPACK_IMPORTED_MODULE_3__wmp_sara_helper__["a"]; });
/**
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_trim__ = __webpack_require__("./node_modules/lodash.trim/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_trim___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_lodash_trim__);
...
var Module = (_temp = _class = function () {
    _createClass(Module, [{
        key: "state",
        get: function get() {
            return this;
    ...
    function Module(namespace, module, runtime) {
        ...
        var _cloneDeep = __WEBPACK_IMPORTED_MODULE_0_lodash_clonedeep___default()(_extends({
            actions: {},
            state: {},
            getters: {},
            mutations: {},
        ...
        __WEBPACK_IMPORTED_MODULE_3_invariant___default()(Object(__WEBPACK_IMPORTED_MODULE_2__util__["b" /* isObject */])(actions), "actions should be object");
        __WEBPACK_IMPORTED_MODULE_3_invariant___default()(Object(__WEBPACK_IMPORTED_MODULE_2__util__["b" /* isObject */])(getters), "getters should be object");
        __WEBPACK_IMPORTED_MODULE_3_invariant___default()(Object(__WEBPACK_IMPORTED_MODULE_2__util__["b" /* isObject */])(mutations), "mutations should be object");
        ...
        try {
            var _loop = function _loop() {
                ...
                Object.defineProperty(state, "" + key, {
                    get: function get() {
                        return fn(_this.state, _this.getters);
                    },
                    enumerable: true
                });
            };

            for (var _iterator = Object.entries(getters)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                _loop();
            }
        } catch (err) {
        ...
        Object(__WEBPACK_IMPORTED_MODULE_4_mobx__["c" /* extendObservable */])(this, state);
        ...
        this.mutations = {};
        var key = namespace;
        namespace = __WEBPACK_IMPORTED_MODULE_1_lodash_trim___default()(namespace, "/");
        if (namespace !== "") {
        ...
        try {
            for (var _iterator2 = Object.entries(actions)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                ...
                this["actions"][_key2] = Object(__WEBPACK_IMPORTED_MODULE_4_mobx__["a" /* action */])(namespace + "/" + _key2, _fn.bind(this));
            }
        } catch (err) {
        ...
        try {
            for (var _iterator3 = Object.entries(mutations)[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                ...
                this["mutations"][_key3] = Object(__WEBPACK_IMPORTED_MODULE_4_mobx__["a" /* action */])(namespace + "/" + _key3, _fn2.bind(this));
            }
        } catch (err) {
    ...
    this._baseModuleCall = function (scope, args, type, payload) {
        ...
        if (Object(__WEBPACK_IMPORTED_MODULE_2__util__["b" /* isObject */])(type)) {
            payload = type;
            if (!type.type) {
...
var Store = (_temp = _class = function () {
    ...
    this.registerModule = function (path, module) {
        __WEBPACK_IMPORTED_MODULE_0_invariant___default()(!_this._modulesNamespaceMap[path], "module must be unique");
        _this._modulesNamespaceMap[path] = new __WEBPACK_IMPORTED_MODULE_1__module__["a" /* default */](path, module, _this);
    };
